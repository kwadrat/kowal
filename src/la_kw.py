...
class WriterGateway(object):
    ...
    def ustaw_sam_styl(self, akt_wiersz, akt_kolumna, the_content=None, kl_miejsc=2, rn_colour=None, bold=0, size=None, italic=None):
        '''
        WriterGateway:
        '''
        m_coor = to_kw.MergedCoords(akt_wiersz, akt_kolumna)
        self.napis_ze_stylem(m_coor, the_content, kl_miejsc=kl_miejsc, rn_colour=rn_colour, bold=bold, size=size, middle=1, italic=italic)
