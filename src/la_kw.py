...
class WriterGateway(object):
    ...
    '''
    def prepare_cell(self, size=None, bold=None, num_format_str=None, wrap=None, vert=None, horz=None, colour=None, borders=None, italic=None, underline=None, fore_colour=None):
        '''
        WriterGateway:
        '''
    ...
    def zapisz_flt(self, akt_wiersz, akt_kolumna, the_content, kl_miejsc=None, rn_colour=None, bold=None, size=None, middle=1, italic=None, underline=None, borders=None, fore_colour=None, liczba_kolumn=1, liczba_wierszy=1):
        '''
        WriterGateway:
        '''
        the_style = self.get_or_generate_style(kl_miejsc=kl_miejsc, rn_colour=rn_colour, bold=bold, size=size, middle=middle, italic=italic, underline=underline, borders=borders, fore_colour=fore_colour)
        self.zapisz_s_polaczone_komorki(akt_wiersz, akt_kolumna, the_content, the_style, liczba_kolumn=liczba_kolumn, liczba_wierszy=liczba_wierszy)
    ...
    def zapisz_wzor(self, akt_wiersz, akt_kolumna, tekst_wzoru, kl_miejsc=None, rn_colour=None, bold=None, size=None, middle=1, italic=None, underline=None, borders=None, fore_colour=None, liczba_kolumn=1, liczba_wierszy=1):
        '''
        WriterGateway:
        '''
