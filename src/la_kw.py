...
class WriterGateway(object):
    ...
    def zapisz_flt(self, akt_wiersz, akt_kolumna, the_content, kl_miejsc=2, size=None, bold=None, rn_colour=None, borders=None, italic=None, fore_colour=None, liczba_kolumn=1, liczba_wierszy=1):
        '''
        WriterGateway:
        '''
        self.zapisz_co_flt(
    ...
    def zapisz_wzor(self, akt_wiersz, akt_kolumna, tekst_wzoru, kl_miejsc=2, size=None, bold=None, rn_colour=None, italic=None, borders=None, fore_colour=None, liczba_kolumn=1, liczba_wierszy=1):
        '''
        WriterGateway:
        '''
