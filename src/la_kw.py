...
class WriterGateway(object):
    def __init__(self):
        ...
        self.n4_style.num_format_str = '#,##0.00_;[Red]-#,##0.00' # Liczby ujemne na czerwono, użyj separatora 1000
    ...
    def zapisz_wzor(self, akt_wiersz, akt_kolumna, tekst_wzoru):
        ...
        WriterGateway:
        '''
        self.sheet.write(akt_wiersz, akt_kolumna, self.xlwt.Formula(tekst_wzoru), self.n1_style)
