...
class WriterGateway(object):
    ...
    def zapisz_flt(self, akt_wiersz, akt_kolumna, the_content, kl_miejsc=None, size=None, bold=None, rn_colour=None, italic=None, borders=None, fore_colour=None, liczba_kolumn=1, liczba_wierszy=1):
        '''
        WriterGateway:
        '''
        self.zapisz_co_flt(
