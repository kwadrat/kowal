...
class WriterGateway(object):
    ...
    def zapisz_flt(self, akt_wiersz, akt_kolumna, the_content, kl_miejsc=None, rn_colour=None, bold=None, size=None, italic=None, borders=None, fore_colour=None, liczba_kolumn=1, liczba_wierszy=1):
        '''
        WriterGateway:
        '''
        self.zapisz_co_flt(
