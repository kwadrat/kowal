...
class WriterGateway(object):
    ...
    def zapisz_stylowe_polaczone_komorki(self, akt_wiersz, akt_kolumna, napis, style, liczba_kolumn):
        '''
        WriterGateway:
        '''
        r1, r2, c1, c2 = wyznacz_cztery(akt_wiersz, akt_kolumna, liczba_kolumn)
    ...
    def zapisz_bold_rozmiar_12_komorki(self, akt_wiersz, akt_kolumna, napis, liczba_kolumn=1):
        ...
        WriterGateway:
        '''
        self.zapisz_stylowe_polaczone_komorki(akt_wiersz, akt_kolumna, napis, style=self.n6_style, liczba_kolumn=liczba_kolumn)
