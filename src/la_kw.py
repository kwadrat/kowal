...
class WriterGateway(object):
    ...
    def __init__(self):
        ...
        self.n17_style = self.prepare_cell(
            12,
            vert=self.xlwt.Alignment.VERT_CENTER,
            horz=self.xlwt.Alignment.HORZ_CENTER,
            borders=nf_kw.brd_1_obk,
        ...
        self.style_map = {
            ...
            ng_kw.NVB_11_STYLE: self.n11_style,
            ng_kw.NVB_12_STYLE: self.n12_style,
            ng_kw.NVB_13_STYLE: self.n13_style,
            ng_kw.NVB_14_STYLE: self.n14_style,
    ...
    def zapisz_lu_polaczone_komorki(self, akt_wiersz, akt_kolumna, napis, style_sel, liczba_kolumn=1, liczba_wierszy=1):
        '''
        WriterGateway:
        '''
    ...
    def zapisz_l_polaczone_komorki(self, akt_wiersz, akt_kolumna, napis, style_sel, liczba_kolumn=1, liczba_wierszy=1):
        ...
        '''
        m_coor = to_kw.MergedCoords(akt_wiersz, akt_kolumna, liczba_kolumn, liczba_wierszy)
        self.write_l_utf(m_coor, napis, style_sel)
