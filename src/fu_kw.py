...
class EnergyReader(CommonReader):
    ...
    def detect_energy_sheet_header(self, hour_server, data_headers):
        '''
        EnergyReader:
        '''
    ...
    def enter_energy_data(self, dfb, key_object, hour_server, data_headers, data_rows):
        '''
        EnergyReader:
        '''
    ...
    def analyze_data_in_grid(self, dfb):
        ...
        under_name = self.detect_energy_sheet_header(hour_server, data_headers)
        key_object = mu_kw.locate_object_key(dfb, under_name)
        data_rows = self.detect_data_rows()
        self.enter_energy_data(dfb, key_object, hour_server, data_headers, data_rows)
