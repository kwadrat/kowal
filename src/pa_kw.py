...
class MojPasek(KlasaObrazu):
    ...
    def __init__(self, lista, tgk, aqr, dwk):
        '''
        MojPasek:
        ...
        '''
        KlasaObrazu.__init__(self, tgk, aqr, dwk, lk_kw.LITERA_PASEK)
    ...
    def dodaj_mouse_over(self, on_mouse, lg_x, lg_y, pd_x, pd_y, wersja):
        ...
        MojPasek:
        '''
        tmp_nazwa2 = mf_kw.plik_grafiki(self.tgk, self.literka_typu, self.dwk.lp_miejsca, wersja)
        slownik = dict(
          px = lg_x,
          py = lg_y,
          kx = pd_x,
